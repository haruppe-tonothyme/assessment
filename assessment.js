...
function　 assessment(userName) {
    ...
    //文字のコード番号の合計を、回答の数で割って、添え字の数値を求める
...
//テストコード
console.assert(assessment('春花') === '春花のいいところは用心深さです。春花の洞察に、多くの人が助けられます。',
    '診断結果の文章の特定の部分を名前におきかえる処理が正しくありません。')
console.assert(
    assessment('春花') === assessment('春花'),
